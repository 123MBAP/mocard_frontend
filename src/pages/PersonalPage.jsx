...
import { 
  ...
  RefreshCw, Globe, ShieldCheck, Download, Copy, QrCode
} from 'lucide-react';
    ...
    <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <div className="bg-white border-b border-slate-200 sticky top-[72px] z-30 select-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-1 sm:space-x-2 overflow-x-auto scrollbar-none py-3 justify-center">
            {[
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === 'card-to-momo' && (
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center animate-in fade-in duration-200 text-left">
                ...
                {calcStatus === 'idle' && (
                  <form onSubmit={handleSimulateTransfer} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] font-bold text-slate-455 uppercase block font-outfit">Send Records Count</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold text-slate-455 uppercase block font-outfit">Target Region</label>
                        <select 
                          value={destCountry} 
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold text-slate-455 uppercase block font-outfit">DB Adapter Driver</label>
                        <span className="w-full text-xs font-bold px-3 py-2.5 bg-slate-100 border border-slate-200 rounded-xl block text-slate-650">
                    ...
                    {/* Recipient Phone */}
                    <div className="space-y-1.5">
                      <label className="text-[9px] font-bold text-slate-455 uppercase block font-outfit">Recipient Endpoint URI</label>
                      <input 
                        type="text" 
                        required
                        value={destPhone} 
                    ...
                    <div className="bg-slate-50 p-4 border border-slate-150 rounded-2xl text-[11px] space-y-1.5">
                      ...
                      <div className="flex justify-between text-slate-455 border-b border-slate-200 pb-1.5">
                ...
                {calcStatus === 'success' && (
                  <div className="py-8 flex flex-col items-center justify-center space-y-4 text-center animate-in zoom-in-95 duration-200">
                    ...
                    <button 
                      ...
                      className="px-5 py-2 rounded-full border border-slate-200 text-slate-555 hover:bg-slate-50 text-[10px] font-bold font-outfit cursor-pointer transition"
                    >
                      Reset Calculator
                    </button>
                  </div>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="border border-slate-200 rounded-2xl overflow-hidden bg-white text-[11px] max-w-md shadow-2xs">
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-slate-100 border-b border-slate-200 text-slate-500 uppercase text-[9px] font-bold tracking-wider">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-4 py-3 font-mono text-slate-650">1 Row = 1,320 Objects</td>
                    ...
                    <tr className="border-t border-slate-100">
                      ...
                      <td className="px-4 py-3 font-mono text-slate-650">1 Row = 1,425 Objects</td>
                      <td className="px-4 py-3 text-right text-emerald-600 font-bold">1.5ms</td>
                    </tr>
                    <tr className="border-t border-slate-100">
                      <td className="px-4 py-3 font-semibold text-slate-800">Azure Blob to Kenya DB</td>
                      <td className="px-4 py-3 font-mono text-slate-650">1 Row = 168 Objects</td>
                      <td className="px-4 py-3 text-right text-emerald-600 font-bold">1.5ms</td>
                    </tr>
                  </tbody>
                </table>
