            ...
            <section className="relative overflow-hidden pt-28 pb-16 lg:pb-20">
                <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center w-full">
                        ...
                        {/* Toggle Button */}
                        <div className="mb-16 inline-flex border border-black/10 bg-white/70 p-1 backdrop-blur-md rounded-full">
                            <button
                                onClick={() => navigate('/')}
                                className="px-8 py-3 text-xs font-bold uppercase tracking-widest transition duration-300 font-sans rounded-full text-black/50 hover:text-black font-semibold"
                            >
                                Individual
                            </button>
                            <button
                                className="px-8 py-3 text-xs font-bold uppercase tracking-widest transition duration-300 font-sans rounded-full bg-[#123c32] text-white shadow-sm font-black"
                            >
                                Business
                            </button>
                        </div>
