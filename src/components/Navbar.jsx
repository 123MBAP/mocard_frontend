        ...
        <div className="flex justify-between items-center h-12">
          ...
          <div className="hidden lg:flex items-center space-x-5 font-outfit">
            <Link 
              to="/developers" 
              onMouseEnter={() => setActiveDropdown(null)}
              className="text-[15px] font-bold text-slate-700 hover:text-pp-brand transition duration-200 px-3 py-2 hover:bg-slate-50"
            >
              Developers
            </Link>
            <Link 
              to="/login" 
              onMouseEnter={() => setActiveDropdown(null)}
              className="px-6 py-2.5 border border-pp-brand text-[15px] font-bold text-pp-brand hover:bg-pp-brand/5 transition duration-200 shadow-sm shadow-pp-brand/5"
            >
              Log In
            </Link>
            <Link 
              to="/contact" 
              onMouseEnter={() => setActiveDropdown(null)}
              className="px-6 py-2.5 bg-pp-brand text-[15px] font-bold text-white hover:brightness-110 transition duration-200 shadow-md shadow-pp-brand/20"
            >
              Sign Up
            </Link>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-8 py-10">
            {activeDropdown === 0 ? (
              ...
              <div className="grid grid-cols-12 gap-8 items-start">
                ...
                <div className="col-span-4 space-y-2.5 text-left">
                  <Link 
                    to="/individual" 
                    onClick={closeMenu} 
                ...
                {/* Column 1: Individual Solution Options */}
                <div className="col-span-4 space-y-4 text-left">
                  ...
                  <div className="flex flex-col space-y-3 font-outfit text-[14.5px] pt-1">
                    <Link to="/individual/shop-pay" onClick={closeMenu} className="text-slate-700 hover:text-pp-brand transition-colors font-medium">
                      Shop &amp; Pay Online
                    </Link>
                    <Link to="/individual/holidays-flights" onClick={closeMenu} className="text-slate-700 hover:text-pp-brand transition-colors font-medium">
                      Holidays &amp; Flights
                    </Link>
                ...
                {/* Right Card / Sidebar */}
                <div className="col-span-4 bg-slate-50 border border-slate-100 p-6 space-y-3.5 shadow-xs text-left">
                  <Link 
                    to="/contact" 
                    onClick={closeMenu}
                    className="flex items-center justify-between px-5 py-3 bg-pp-brand text-sm font-bold text-white hover:brightness-110 transition duration-200 group w-full shadow-sm shadow-pp-brand/20"
                  >
              ...
              <div className="grid grid-cols-12 gap-8 items-start">
                ...
                {/* Left Side Header Block */}
                <div className="col-span-3 space-y-2.5 text-left">
                  <Link 
                    to="/solutions" 
                    onClick={closeMenu} 
                    className="group inline-flex items-center space-x-2 text-xl font-black font-outfit text-pp-black hover:text-pp-brand transition-colors duration-200"
                ...
                <div className="col-span-3 space-y-4 text-left">
                  ...
                  <div className="flex flex-col space-y-3 font-outfit text-[14.5px] pt-1">
                    <Link to="/business/payment-links" onClick={closeMenu} className="text-slate-700 hover:text-pp-brand transition-colors font-medium">
                      Payment Links
                    </Link>
                    <Link to="/business/hosted-checkouts" onClick={closeMenu} className="text-slate-700 hover:text-pp-brand transition-colors font-medium">
                      Hosted Checkouts
                    </Link>
                    <Link to="/business/donations" onClick={closeMenu} className="text-slate-700 hover:text-pp-brand transition-colors font-medium">
                      Donations &amp; Payments
                    </Link>
                  </div>
                </div>
                ...
                {/* Right Card / Sidebar */}
                <div className="col-span-3 bg-slate-50 border border-slate-100 p-6 space-y-3.5 shadow-xs text-left">
                  <Link 
                    to="/contact" 
                    onClick={closeMenu}
                    className="flex items-center justify-between px-5 py-3 bg-pp-brand text-sm font-bold text-white hover:brightness-110 transition duration-200 group w-full shadow-sm shadow-pp-brand/20"
        ...
        <div className="lg:hidden border-t border-slate-100 bg-white/95 backdrop-blur-md py-4 px-6 space-y-4 shadow-inner max-h-[85vh] overflow-y-auto">
          <div className="space-y-1 font-outfit text-base">
            ...
            <div>
              <button 
                ...
                className="w-full flex justify-between items-center px-4 py-3 hover:bg-slate-50 text-pp-black font-bold transition duration-200"
              >
                <span>Individual</span>
              ...
              {mobileSection === 'individual' && (
                <div className="pl-6 pr-4 py-2 space-y-3 bg-slate-50/50 mt-1">
                  <Link to="/individual/shop-pay" onClick={closeMenu} className="block text-sm text-slate-700 hover:text-pp-brand font-medium py-1">Shop &amp; Pay Online</Link>
                  <Link to="/individual/holidays-flights" onClick={closeMenu} className="block text-sm text-slate-700 hover:text-pp-brand font-medium py-1">Holidays &amp; Flights</Link>
            ...
            <div>
              ...
              {mobileSection === 'business' && (
                <div className="pl-6 pr-4 py-2 space-y-3 bg-slate-50/50 mt-1">
                  <Link to="/business/payment-links" onClick={closeMenu} className="block text-sm text-slate-700 hover:text-pp-brand font-medium py-1">Payment Links</Link>
                  <Link to="/business/hosted-checkouts" onClick={closeMenu} className="block text-sm text-slate-700 hover:text-pp-brand font-medium py-1">Hosted Checkouts</Link>
                  <Link to="/business/donations" onClick={closeMenu} className="block text-sm text-slate-700 hover:text-pp-brand font-medium py-1">Donations &amp; Payments</Link>
            ...
            <Link 
              to="/developers" 
              onClick={closeMenu}
              className="block px-4 py-3 hover:bg-slate-50 text-pp-black font-bold transition duration-200"
            >
              Developers
            </Link>
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col space-y-3 font-outfit">
            <Link 
              to="/dashboard" 
              onClick={closeMenu}
              className="w-full text-center py-3 border border-pp-brand text-sm font-bold text-pp-brand hover:bg-pp-brand/5 transition duration-200"
            >
              Log In
            </Link>
            <Link 
              to="/contact" 
              onClick={closeMenu}
              className="w-full text-center py-3 bg-pp-brand text-sm font-bold text-white hover:brightness-110 transition duration-200"
            >
              Sign Up
            </Link>
          </div>
